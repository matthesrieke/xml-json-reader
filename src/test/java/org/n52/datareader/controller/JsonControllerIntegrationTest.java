...
public class JsonControllerIntegrationTest {
    ...
    public void jsonResponseStatusIsOk() throws ClientProtocolException, IOException {
        ...
        HttpUriRequest request = new HttpGet("http://localhost:8080/json-data");
    ...
    public void listReturnedHasTheSizeOf24()throws Exception{
        assertEquals(jsonController.viewMeasurementsJson().size(), 24);
    }
    ...
    public void jsonResponseIsNotNull() throws Exception {
        assertThat(jsonController).isNotNull();
