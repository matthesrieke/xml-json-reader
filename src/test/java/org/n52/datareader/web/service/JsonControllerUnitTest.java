...
class JsonControllerUnitTest {
    ...
    @Test
    public void readJsonDataTest() throws Exception {
        ...
        when(dataService.getData(MediaType.APPLICATION_JSON_VALUE)).thenReturn(measurementsSample);
        mockMvc.perform(get("/api/json-data")).andExpect(status().isOk()).andDo(print()).andExpect(content().json(jsonString));
    }
