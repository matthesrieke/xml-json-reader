...
class CsvControlleraUnitTest {
    ...
    @Test
    public void readCsvDataTest() throws Exception {
        ...
        when(dataService.getData("text/csv")).thenReturn(measurementsSample);
        mockMvc.perform(get("/api/csv-data")).andExpect(status().isOk()).andDo(print()).andExpect(content().json(jsonString));
    }
